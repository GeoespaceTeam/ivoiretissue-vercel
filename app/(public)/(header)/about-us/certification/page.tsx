          ...
          <div className="fac-form-container">
            <div className="fac-form-card">
              ...
              <form onSubmit={(e) => e.preventDefault()}>
                <label className="fac-label">Name *</label>
                <input
                  type="text"
                  className="fac-input"
                ...
                <label className="fac-label">Phone</label>
                <input
                  type="tel"
                  className="fac-input"
                ...
                <label className="fac-label">Email *</label>
                <input
                  type="email"
                  className="fac-input"
                ...
                <label className="fac-label">Message</label>
                <textarea
                  className="fac-textarea"
                  placeholder="Tell us about your certification requirements or OEM needs..."
                ></textarea>

                <button type="submit" className="fac-submit">
                  Submit
                </button>
              </form>
            </div>
